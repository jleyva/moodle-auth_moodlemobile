...
// TODO check for XSS possible attacks, I'm not sure if we should do that.

// TODO add events prior to integration incore.

// TODO some parts of the code are reused from login/token.
//
...
// Check if the Moodle Mobile auth plugin is enabled and correctly configured.
$auth = 'moodlemobile';

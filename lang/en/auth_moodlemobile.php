...
/**
 * Strings for component 'auth_moodlemobile', language 'en'.
 *
...
$string['loginintheapp'] = 'The user must log in using the app';
$string['logininthebrowser'] = 'The user must log in using the default mobile browser and opening the site (mandatory for SSO plugins)';
$string['loginfirstappthenbrowser'] = 'The user can log in using the app  but if it fails try in the browser (recommended when using different authentication methods)';
